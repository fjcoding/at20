...
describe('Tests for diamonds deck of cards', () => {
    it('can have 2D the diamonds cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[0], decks[1]);
    ...
    it('can have 3D the diamonds cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[1], decks[1]);
    ...
    it('can have 4D the diamonds cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[2], decks[1]);
    ...
    it('can have 5D the diamonds cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[3], decks[1]);
    ...
    it('can have 6D the diamonds cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[4], decks[1]);
    ...
    it('can have 7D the diamonds cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[5], decks[1]);
    ...
    it('can have 8D the diamonds cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[6], decks[1]);
    ...
    it('can have 9D the diamonds cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[7], decks[1]);
    ...
    it('can have TD the diamonds cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[8], decks[1]);
    ...
    it('can have JD the diamonds cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[9], decks[1]);
    ...
    it('can have QD the diamonds cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[10], decks[1]);
    ...
    it('can have KD the diamonds cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[11], decks[1]);
    ...
    it('can have AD the diamonds cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[12], decks[1]);
...
describe('Tests for hearts deck of cards', () => {
    it('can have 2H the hearts cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[0], decks[2]);
    ...
    it('can have 3H the hearts cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[1], decks[2]);
    ...
    it('can have 4H the hearts cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[2], decks[2]);
    ...
    it('can have 5H the hearts cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[3], decks[2]);
    ...
    it('can have 6H the hearts cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[4], decks[2]);
    ...
    it('can have 7H the hearts cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[5], decks[2]);
    ...
    it('can have 8H the hearts cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[6], decks[2]);
    ...
    it('can have 9H the hearts cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[7], decks[2]);
    ...
    it('can have TH the hearts cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[8], decks[2]);
    ...
    it('can have JH the hearts cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[9], decks[2]);
    ...
    it('can have QH the hearts cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[10], decks[2]);
    ...
    it('can have KH the hearts cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[11], decks[2]);
    ...
    it('can have AH the hearts cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[12], decks[2]);
...
describe('Tests for spades deck of cards', () => {
    it('can have 2S the spades cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[0], decks[3]);
    ...
    it('can have 3H the spades cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[1], decks[3]);
    ...
    it('can have 4H the spades cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[2], decks[3]);
    ...
    it('can have 5H the spades cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[3], decks[3]);
    ...
    it('can have 6H the spades cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[4], decks[3]);
    ...
    it('can have 7H the spades cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[5], decks[3]);
    ...
    it('can have 8H the spades cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[6], decks[3]);
    ...
    it('can have 9H the spades cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[7], decks[3]);
    ...
    it('can have TH the spades cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[8], decks[3]);
    ...
    it('can have JH the spades cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[9], decks[3]);
    ...
    it('can have QH the spades cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[10], decks[3]);
    ...
    it('can have KH the spades cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[11], decks[3]);
    ...
    it('can have AH the spades cards', () => {
        const valueCard = ['2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A'];
        const decks = ['C', 'D', 'H', 'S'];
        const card = new cardDeck(valueCard[12], decks[3]);
